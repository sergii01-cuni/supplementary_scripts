/**
	...
	def colorOuter2Margin = getColorRGB(0, 200, 200)
	...
	// Get the outer margin area
	def geomOuter2 = areaTumor.buffer(2*expandPixels)
	def geomOuter_filled = areaTumor.buffer(expandPixels)
  	geomOuter2 = geomOuter2.difference(geomOuter_filled)
	//geomOuter2 = geomOuter2.difference(areaTumor)
	geomOuter2 = geomOuter2.intersection(areaTissue)
	def roiOuter2 = GeometryTools.geometryToROI(geomOuter2, plane)
	def annotationOuter2 = PathObjects.createAnnotationObject(roiOuter2)
	annotationOuter2.setName("Peritumor")
	annotationOuter2.setColorRGB(colorOuter2Margin)
	...
	def annotationsToAdd = [annotationOuter2, annotationOuter, annotationInner, annotationCentral];
